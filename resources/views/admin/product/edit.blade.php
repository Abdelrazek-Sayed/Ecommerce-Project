...
@section('content')
        ...
        <div class="sl-pagebody">
            <div class="card pd-20 pd-sm-40">
                ...
                @if ($errors->any())
                    ...
                    @endforeach
                @endif
                <form method="post" action="{{ url("admin/dashboard/product/update/$product->id") }}"
                            ...
                            <div class="col-lg-4">
                                <div class="form-group mg-b-10-force">
                                    ...
                                    <select class="form-control select2" name="subcategory_id">
                                        ...
                                        <option @if ($product->subcat->id == $product->subcategory_id) selected @endif value=" {{ $product->subcat->id }}">
                                            {{ $product->subcat->name }}
                                        </option>
    ...
    <div class="container">
        <div class="sl-pagebody">
            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">Upadte Photos</h6>
                <br>
                @if ($errors->any())
                    @foreach ($errors->all() as $error)
                        <div class="alert alert-danger">
                    ...
                    @endforeach
                @endif
                <form method="post" action="{{ url("admin/dashboard/product/updatePhoto/$product->id") }}"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="col-lg-12">
                        ...
                        <div class="form-group col-lg-6" style="float:right">
                            <img src="{{ asset("uploads/$product->image_one") }}" style="height:70px; width:100px"
                                id="one">
                        </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-group col-lg-6" style="float:right">
                            <img src="{{ asset("uploads/$product->image_two") }}" style="height:70px; width:100px"
                                id="two">
                        </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-group col-lg-6" style="float:right">
                            <img src="{{ asset("uploads/$product->image_three") }}" style="height:70px; width:100px"
                                id="three">
                        </div>
                    </div><!-- col-4 -->
                    <br><br>
                    <div class="form-layout-footer" style="float:left">
                        <button class="btn btn-warning" type="submit">Update photo</button>
                    </div><!-- form-layout-footer -->
                </form>
            </div><!-- card -->
        </div>
